...
set_property -dict [list CONFIG.XML_INPUT_FILE "../../vc707-ddr3-800mhz.prj" CONFIG.RESET_BOARD_INTERFACE {Custom} CONFIG.MIG_DONT_TOUCH_PARAM {Custom} CONFIG.BOARD_MIG_PARAM {Custom}] [get_ips $corename]
