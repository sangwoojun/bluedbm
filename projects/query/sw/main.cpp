...
int main(int argc, char** argv) {
	...
	char* querystring = (char*)malloc(8192);
	for ( int i = 0; i < 8192; i++ ) querystring[i] = 0x7f;
	strncpy(querystring,       "hello world", 16);
	strncpy(querystring+16,    "123456789012345678901234567890", 32);
	strncpy(querystring+16+32, "hello world         0123456789", 32);
