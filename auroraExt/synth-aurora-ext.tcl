proc genAurora {corename propertyList} {
	...
	create_ip -name aurora_64b66b -version 11.0 -vendor xilinx.com -library ip -module_name $corename -dir ./$coredir
...
genAurora "aurora_64b66b_X1Y16" [list CONFIG.C_AURORA_LANES {1} CONFIG.C_LINE_RATE {10.0} CONFIG.C_REFCLK_FREQUENCY {625.000} CONFIG.interface_mode {Streaming} CONFIG.C_GT_LOC_25 {1} CONFIG.C_GT_LOC_1 {X} CONFIG.drp_mode {Native}]

genAurora "aurora_64b66b_X1Y17" [list CONFIG.C_AURORA_LANES {1} CONFIG.C_LINE_RATE {10.0} CONFIG.C_REFCLK_FREQUENCY {625.000} CONFIG.interface_mode {Streaming} CONFIG.C_GT_LOC_25 {1} CONFIG.C_GT_LOC_1 {X} CONFIG.drp_mode {Native}]

genAurora "aurora_64b66b_X1Y18" [list CONFIG.C_AURORA_LANES {1} CONFIG.C_LINE_RATE {10.0} CONFIG.C_REFCLK_FREQUENCY {625.000} CONFIG.interface_mode {Streaming} CONFIG.C_GT_LOC_25 {1} CONFIG.C_GT_LOC_1 {X} CONFIG.drp_mode {Native}]

genAurora "aurora_64b66b_X1Y19" [list CONFIG.C_AURORA_LANES {1} CONFIG.C_LINE_RATE {10.0} CONFIG.C_REFCLK_FREQUENCY {625.000} CONFIG.interface_mode {Streaming} CONFIG.C_GT_LOC_25 {1} CONFIG.C_GT_LOC_1 {X} CONFIG.drp_mode {Native}]
